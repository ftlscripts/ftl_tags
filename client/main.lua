...
RegisterNetEvent('ftl_tags:owned')
AddEventHandler('ftl_tags:owned',function(own,group)
    owned = own
    if own then
        ownedGroup = group
...
RegisterNetEvent('ftl_tags:set_admins')
AddEventHandler('ftl_tags:set_admins',function (admins)
...
AddEventHandler('esx:playerLoaded',function()
    ESX.TriggerServerCallback('ftl_tags:getAdminsPlayers',function(admins)
        currentAdminPlayers = admins
    end)
end)
